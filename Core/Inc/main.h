...
#define DUMMY_BYTE                 0x00  // Dummy byte (SPI)
#define FOREVER                       1  // Forever (while loop)
#define FLOAT_NAN            0x7FFFFFFF  // Invalid float value (NAN)
#define OK                         0x55  // OK (FW Update)
#define NOT_OK                     0xAA  // Not OK (FW Update)
